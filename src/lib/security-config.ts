...
export const SECURITY_CONFIG = {
  ...
  SECURITY_HEADERS: {
    ...
    "Content-Security-Policy": [
      ...
      } http://localhost:8000 http://127.0.0.1:8000 http://10.153.38.110:8000 https://www.google-analytics.com;`,
      "img-src 'self' data: blob: http: https:;",
      "font-src 'self' data:;",
      "frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://www.google.com https://api.razorpay.com;",
...
export function isAllowedFileType(mimeType: string): boolean {
  return (SECURITY_CONFIG.ALLOWED_FILE_TYPES as readonly string[]).includes(
    mimeType
  );
}
