...
const AnimatedCounter: React.FC<AnimatedCounterProps> = ({ counter, inView }) => {
  ...
  return (
    <span className="text-2xl md:text-3xl lg:text-4xl font-bold text-white drop-shadow-lg">
      {counter.prefix}{formatNumber(currentValue)}{counter.suffix}
    </span>
  );
};
...
const getIcon = (iconName: string) => {
  ...
  switch (iconName) {
    case '🗺️': return <MapPin {...iconProps} />;
    case '👥': return <Users {...iconProps} />;
    case '🙋‍♂️': return <Heart {...iconProps} />;
...
const getColorClasses = (color: string) => {
  switch (color) {
    case 'orange': return 'from-orange-500/90 to-orange-700/90';
    case 'blue': return 'from-blue-500/90 to-blue-700/90';
    case 'green': return 'from-green-500/90 to-green-700/90';
    case 'purple': return 'from-purple-500/90 to-purple-700/90';
    default: return 'from-primary/90 to-primary/70';
  }
};
          ...
          {highlightsData.counters.map((counter, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${getColorClasses(counter.color || 'orange')} opacity-85 group-hover:opacity-90 transition-opacity duration-300`} />
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              राष्ट्रीय सेवा संघ की बढ़ती सफलता में आपका योगदान अमूल्य है। 
              हमारे साथ जुड़कर इन आंकड़ों को और बेहतर बनाने में सहायता करें।
            </p>
          </div>
        </div>
      </div>
