...
const WhyWeExistSection: React.FC<WhyWeExistSectionProps> = ({
  whyWeExist,
}) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-8 sm:mb-12">
            ...
            >
              हमारे अस्तित्व का उद्देश्य और समाज के कल्याण के लिए हमारा
              दृष्टिकोण
            </motion.p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16">
            {whyWeExist.content.map((item, index) => (
              <Card
                key={index}
                className="p-4 sm:p-6 shadow-sm hover:shadow-lg transition-shadow"
              >
                <motion.p
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
            ...
            <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  >
                    हम उस अंधकार के विरुद्ध हैं जो हमारे धर्म को क्षीण कर रहा
                    है।
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 30 }}
                    ...
                    className="text-base sm:text-lg"
                  >
                    हम उस अन्याय के विरुद्ध हैं जो हमारी बहनों, माताओं और
                    मंदिरों पर हो रहा है।
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    ...
                    className="text-base sm:text-lg"
                  >
                    हम उस विस्मृति के विरुद्ध हैं जो हमें हमारी संस्कृति, वेद,
                    उपनिषद और गुरुकुलों से दूर ले जा रही है।
                  </motion.p>
                </div>
              </div>
            </CardContent>
