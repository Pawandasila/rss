        ...
        >
          ...
          <div className="relative p-8 sm:p-10 bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 text-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-3">
              ...
              <motion.p
                ...
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="text-lg sm:text-xl opacity-90 italic"
              >
              ...
              <motion.p
                ...
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="text-base sm:text-lg leading-relaxed pt-4"
              >
                {ourCall.commitment.split("*").map((part, idx) =>
                  idx % 2 === 1 ? (
                    <strong key={idx} className="font-bold underline">
                      {part}
                    </strong>
                  ) : (
                    part
          ...
          <div className="space-y-6">
            <motion.h3
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground text-center"
            >
          ...
          <div className="p-6 sm:p-8 border-l-4 border-red-500 bg-gradient-to-r from-red-50 to-transparent dark:from-red-950/20 rounded-r-xl">
            <motion.p
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="text-base sm:text-lg text-foreground leading-relaxed font-medium"
            >
