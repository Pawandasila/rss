    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-muted/30 relative">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
          className="border border-gray-200 bg-gradient-to-br from-background via-background/95 to-background/90 overflow-hidden rounded-2xl shadow-xl"
        >
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-primary/10 to-primary/5 border-l-4 border-primary p-6 rounded-r-xl">
                <p className="text-primary font-semibold text-base text-justify sm:text-lg leading-relaxed lg:text-justify">
                  राष्ट्रीय सेवा संघ का प्रत्येक धर्म रक्षक, वेद और उपनिषदों में
                  निहित सनातन सत्य को आत्मसात कर, भारतवर्ष की एकता, अखंडता और
                  सांस्कृतिक गरिमा की रक्षा हेतु पूर्ण समर्पण भाव से सेवा कार्य
                  में संलग्न है।
                </p>
              </div>
            </div>
