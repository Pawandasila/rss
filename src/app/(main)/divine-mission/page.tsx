...
const missionSectionData = {
  ...
  subtitle:
    "समाज के हर वर्ग को सशक्त और आत्मनिर्भर बनाना, यही हमारा ध्येय और संकल्प है।",
};
...
const DivineMissionPage = () => {
  ...
  const displayMissions: DisplayMission[] = useMemo(() => {
    ...
    return dynamicMissions.map((mission) => ({
      ...
      alt: mission.title,
      type: "ongoing", // Default to ongoing as API doesn't have type yet
      author: {
        name: "Admin", // Fallback author
        role: "Administrator",
      },
