...
const HeroSection = () => {
  return (
    <motion.section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-primary/80">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-16 lg:py-24">
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="mb-4 sm:mb-6 inline-flex flex-col items-center gap-3"
          >
          ...
          <motion.h1
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="text-xl sm:text-3xl md:text-4xl lg:text-6xl font-black mb-4 sm:mb-6 leading-tight text-white px-2"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="max-w-4xl mx-auto mb-6 sm:mb-8 px-2"
          >
            ...
            <p className="text-xs sm:text-base md:text-lg text-white/85 leading-relaxed">
              धार्मिक मूल्यों की रक्षा, बहन बेटियों की सुरक्षा, मठ मंदिरों का
              संरक्षण, शिक्षा स्वास्थ्य एवं रोजगार की स्थिति सुधार, धार्मिक
              संस्कारों को बचाने हेतु गुरुकुल संचालन एवं भारतीय संस्कृति को पुनः
              गौरव प्रदान करने में अपना योगदान दें।
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-1.5 sm:gap-2 bg-white/15 backdrop-blur-sm rounded-lg sm:rounded-xl px-2.5 sm:px-4 py-1.5 sm:py-2.5 border border-white/20 hover:bg-white/20 transition-colors">
              ...
              <span className="font-semibold text-white text-[10px] sm:text-sm whitespace-nowrap">
                80G & 12AA कर मुक्त
              </span>
            </div>
            <div className="flex items-center gap-1.5 sm:gap-2 bg-white/15 backdrop-blur-sm rounded-lg sm:rounded-xl px-2.5 sm:px-4 py-1.5 sm:py-2.5 border border-white/20 hover:bg-white/20 transition-colors">
