          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6 lg:space-y-8">
              ...
              <p className="text-base sm:text-lg text-primary-foreground/90 leading-relaxed max-w-2xl">
                राष्ट्रीय सेवा संघ भारतवर्ष के साथ जुड़कर राष्ट्र सेवा में अपना
                योगदान दें। हमें आपकी सेवा और सहयोग की प्रतीक्षा है।
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-primary-foreground/30 text-primary hover:bg-primary-foreground hover:text-primary backdrop-blur-sm"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              हमारे कार्यालयों से संपर्क करें या हमारे सामाजिक माध्यमों पर
              जुड़ें
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 lg:mb-16">
            ...
            <div className="group p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 bg-background border border-border rounded-xl hover:-translate-y-2">
              ...
              <Link
                ...
                className="text-primary font-bold text-xs sm:text-base lg:text-lg hover:underline transition-colors break-all"
              >
                94296 93593
              </Link>
            </div>
            ...
            <div className="group p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 bg-background border border-border rounded-xl hover:-translate-y-2 col-span-2 lg:col-span-1">
              ...
              <p className="text-muted-foreground mb-2 sm:mb-3 text-xs sm:text-sm lg:text-base">
                सोमवार - शुक्रवार
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="group p-6 sm:p-8 hover:shadow-2xl transition-all duration-500 bg-background border border-border rounded-xl hover:-translate-y-2">
              ...
              <p className="text-muted-foreground mb-4 lg:mb-6 leading-relaxed text-sm sm:text-base">
                D BLOCK, POCKET-5 (Flat No. 34)
                <br />
                DDA Flat, CRPF Flat, Bawana
                <br />
                New Delhi – 110040
              </p>
              <Button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-4">
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full sm:w-auto bg-gradient-to-r from-primary to-primary/90 text-primary-foreground hover:from-primary/90 hover:to-primary shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 px-8 h-11 lg:h-12 text-sm lg:text-base font-semibold rounded-lg"
                  >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <Button
              asChild
              variant="outline"
              className="h-14 lg:h-16 group border-2 hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              <a
                href="https://facebook.com/joinrss"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <Button
              asChild
              variant="outline"
              className="h-14 lg:h-16 group border-2 hover:border-sky-500 hover:bg-sky-50 dark:hover:bg-sky-950 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              <a
            ...
            <Button
              asChild
              variant="outline"
              className="h-14 lg:h-16 group border-2 hover:border-pink-500 hover:bg-pink-50 dark:hover:bg-pink-950 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              <a
                href="https://instagram.com/joinrss"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center gap-2"
              >
            ...
            <Button
              asChild
              variant="outline"
              className="h-14 lg:h-16 group border-2 hover:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-950 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              <a
                href="https://linkedin.com/company/joinrss"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center gap-2"
              >
          ...
          <div className="relative overflow-hidden shadow-2xl rounded-2xl">
            ...
            <div className="relative z-10 p-8 sm:p-12 lg:p-16 text-center">
              ...
              <p className="text-base sm:text-lg mb-8 lg:mb-10 text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed">
                आपका छोटा सा योगदान भी राष्ट्र निर्माण में महत्वपूर्ण भूमिका
                निभा सकता है। आज ही हमसे जुड़कर धर्म और संस्कृति की रक्षा में
                भागीदार बनें।
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  asChild
                  size="lg"
                  className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 px-6 h-11 lg:h-12 text-sm lg:text-base font-semibold rounded-lg"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-2 border-primary-foreground/30 text-primary hover:bg-primary-foreground hover:text-primary backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 px-6 h-11 lg:h-12 text-sm lg:text-base font-semibold rounded-lg"
                >
