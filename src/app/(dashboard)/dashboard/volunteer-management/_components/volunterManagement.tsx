...
import { Pencil, X, Trash2, Search, Users } from "lucide-react";
...
export default function VolunteerTable() {
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <EmptyState
          ...
          description="Please wait while we fetch the volunteer data"
        />
      </div>
    );
  }
  ...
  if (!volunteers || volunteers.length === 0) {
    return (
      <EmptyState
        ...
        description="There are no volunteers registered yet. Create your first volunteer to get started."
      />
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      <div className="overflow-x-auto rounded-lg border">
        <Table>
          ...
          <TableBody>
            {(volunteers || []).map((r: VolunteerWithUser) => (
              <TableRow key={r.id}>
      ...
      {totalPages > 1 && (
        <div className="mt-4 flex items-center justify-between">
          <p className="text-sm text-muted-foreground">
            Page {page} of {totalPages} • Total {totalCount} volunteers
          </p>
          <Pagination>
            <PaginationContent>
              <PaginationItem>
          ...
          {waVolunteer && (
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={saveWorkingAreas} disabled={waSaving}>
